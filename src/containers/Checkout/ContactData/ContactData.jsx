...
class ContactData extends Component {
  ...
  inputChangeHandler = (event, inputIndentifier) => {
    const updatedOrderForm = { ...this.state.orderForm }; //not clone depply becuz nested obj
    const updatedFormEle = { ...updatedOrderForm[inputIndentifier] };
    ...
    updatedOrderForm[inputIndentifier] = updatedFormEle;
